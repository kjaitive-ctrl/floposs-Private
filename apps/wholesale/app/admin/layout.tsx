...
const menus: MenuItem[] = [
  { label: "계정관리", path: "/admin/accounts",         badgeKey: "pendingAccounts" },
  { label: "문의처리", path: "/admin/inquiries",        badgeKey: "openInquiries" },
  { label: "구독플랜", path: "/admin/plans" },
  { label: "업종관리", path: "/admin/account-types" },
  { label: "일반설정", path: "/admin/general-settings" },
  { label: "약관관리", path: "/admin/legal" },
    ...
    <div className="min-h-screen flex">
      <aside className="w-56 bg-gray-900 text-white flex flex-col fixed h-full">
        <div className="p-5 border-b border-gray-700">
          ...
          <p className="text-xs text-gray-400 mt-0.5">도매 POS 관리자</p>
        </div>
